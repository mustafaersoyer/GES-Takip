...
public class UretimAnaliz extends Fragment implements BackPressObserver{
    ...
    final public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
      //kodlar buraya
        View view = inflater.inflate(R.layout.uretim_analiz,container,false);
       return view;
    ...
    final public void onViewCreated(View view, @Nullable Bundle savedInstanceState){
            ...
            url = "http://192.168.30.240:80/uretim.php?tesisId=" + gelenTesisId + "&tarih=" + yil; //varsayılan aylık gösterimdir.
...
//LineChart Verisi
            veriGetir(new CallBack() {
                ...
                final public void onSuccess(float[] list) {
                    ...
                    LINEDATASET = new LineDataSet(LineEntries, "Üretim");
                    if (EntryLabels != null) {
                        EntryLabels.clear();
                    ...
                    LINEDATASET.setColor(R.color.grafik_blue);
...
//BarChart Verisi
            veriGetir(new CallBack() {
                ...
                final public void onSuccess(float[] list) {
                    ...
                    BARDATASET.setColor(R.color.grafik_blue);
...
//PieChart Verisi
                    ...
                    popupmenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                        ...
                        public boolean onMenuItemClick(MenuItem menuItem) {
                            if (menuItem.getTitle().equals("Tam Ekran")) {
                                ...
                                tarihAl();
                                url = "http://192.168.30.240:80/uretim.php?tesisId=" + gelenTesisId + "&tarih=" + yil + "-" + ay + "-" + gun;
                                secim = "Saatlik";
                                veriGetir(new CallBack() {
                                    @Override
                                    final public void onSuccess(float[] list) {
                                ...
                                tarihAl();
                                url = "http://192.168.30.240:80/uretim.php?tesisId=" + gelenTesisId + "&tarih=" + yil;
                                secim = "Aylık";
                                veriGetir(new CallBack() {
                                    @Override
                                    final public void onSuccess(float[] list) {
                                        ...
                                        LINEDATA = new LineData(EntryLabels, LINEDATASET);
                                        LINEDATASET.setColor(R.color.grafik_blue);LINEDATASET.setDrawFilled(true);
                                        LINEDATASET.setDrawCubic(true);
                                        LINEDATASET.setDrawFilled(true);
                                        LINEDATASET.setValueTextSize(10);
                                        lineChart.setDescription("");
                            ...
                            if (menuItem.getTitle().equals("Tam Ekran")) {
                                ...
                                veriGetir(new CallBack() {
                                    ...
                                    final public void onSuccess(float[] list) {
                                        ...
                                        BARDATA = new BarData(BarEntryLabels, BARDATASET);
                                        BARDATASET.setColor(R.color.grafik_blue);
                                        BARDATASET.setBarShadowColor(R.color.grafik_blue);
                                        BARDATASET.setValueTextSize(10);
                                        barChart.setDescription("");
                                        barChart.setTouchEnabled(true);
                                        barChart.setData(BARDATA);
            ...
            pieChart.setOnChartGestureListener(new OnChartGestureListener() {
                ...
                final public void onChartSingleTapped(MotionEvent me) {
                    ...
                    popupmenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                        @Override
                        final public boolean onMenuItemClick(MenuItem menuItem) {
                            if (menuItem.getTitle().equals("Tam Ekran")) {
                                barChart.setVisibility(View.GONE);
                                lineChart.setVisibility(View.GONE);
                                ...
                                tarihAl();
                                url = "http://192.168.:80/uretim.php?tesisId=" + gelenTesisId + "&tarih=" + yil;
                                secim = "Aylık";
                                veriGetir(new CallBack() {
                                    @Override
                                    final public void onSuccess(float[] list) {
                    ...
                    final public void onResponse(String response) {
                        ...
                        try {
                            ...
                            while (i < uzunluk - 2) {
                                ...
                                float miktar = jsonBody.getInt("uretimMiktar");
                                liste[i-1]=miktar;
                            }
